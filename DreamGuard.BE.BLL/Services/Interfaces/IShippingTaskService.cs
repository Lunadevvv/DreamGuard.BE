...
namespace DreamGuard.BE.BLL.Services.Interfaces
{
    public interface IShippingTaskService
    {
        ...
        Task<Result> ProcessReturnedOrderAsync(Guid taskId, ProcessReturnedRequest request, Guid managerId);
        Task<Result> ProcessExchangeOrderAsync(Guid taskId, ProcessExchangeRequest request, Guid managerId);
        ...
        Task<Result> CompleteShippingForTradeInOrderAsync(Guid taskId, Guid staffId, CompleteShippingForTradeInRequest request); // delivered-for-tradeIn
