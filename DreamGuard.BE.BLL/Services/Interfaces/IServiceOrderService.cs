...
namespace DreamGuard.BE.BLL.Services.Interfaces
{
    ...
    {
        Task<Result> RescheduleServiceOrder(Guid serviceOrderId, DateTime newAppointmentDate, string staffReason);
        ...
        Task<Result<PaginatedList<ServiceOrderResponse>>> GetAllAsync(Guid customerId, int pageNumber, int pageSize);
